...
hm_buff_num<-1;
zm_buff<-[
    ["僵尸BUFF：毒降价5000→3500","sm_rcon sm_xsys_config change xsys.items.poison.price 3500"],
...
hm_buff<-[
    ...
    ["人类BUFF：加血雷价格下调至4500","sm_rcon sm_xsys_config change xsys.items.flash.price 4500"]
];
reset_buff<-[
    "sm_rcon sm_xsys_config change xsys.items.poison.price 5000","sm_rcon sm_xsys_config change xsys.zmpoison.radius 192",
    "sm_rcon sm_xsys_config change xsys.zmpoison.duration 5","sm_cvar zr_infect_mzombie_ratio 7","sm_rcon sm_xsys_config change xsys.zmpoison.damage 12",
    ...
    "sm_cvar sm_flash_limit 1","sm_cvar sm_he_limit 3","sm_rcon sm_xsys_config change xsys.items.flash.price 8000"
]
