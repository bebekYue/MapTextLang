...
musdelay <- 30.00;								//delay before playing final song after boss is killed (final door/events are based on this)
...
sephlaser_damage <- 23;							//damage from sepiroth's laser on-touch
damage_touch_boss <- 29;						//damage to deal from touching boss (scorpion guard)
